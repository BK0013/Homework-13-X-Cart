...
public class ShoppingTest extends TestBase {
    ...
    public void verifythatUserShouldPlaceOrderSuccessfullyForCupOfMojoBluetooth() throws InterruptedException {
        ...
        shopping.sendTextToEmail("bkpatel13@gmail.com");
        ...
        shopping.firstNameField("bk");
        shopping.lastNameField("patel");
        shopping.streetField("420,katappa Street");
        shopping.cityField("hatfield");
        shopping.countryCode("UK");
        shopping.stateField("hertfordshire");
        shopping.zipCodeField("al10 8lb");
        shopping.clickOnCreatAccount();
        shopping.enterPassWord("katappa420");
        Thread.sleep(3000);
